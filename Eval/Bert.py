...
output_file = 'bert_multiclass_predictions.txt'
...
if isinstance(model, DataParallel):
    model.module.save_pretrained('bert_multiclass_classification_model_with_gpus')
else:
    model.save_pretrained('bert_multiclass_classification_model_with_gpus')
