...
# 函数：加载并采样数据
def load_and_sample_data(file_path, fraction=0.2):
    texts = []
    labels = []
...
output_file = 'lstm_multiclass_predictions.txt'
...
model.save('lstm_multiclass_classification_model_with_gpus.h5')
