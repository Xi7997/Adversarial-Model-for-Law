...
train_path = "article_train.json"
test_path = "article_test.json"
valid_path = "article_valid.json"
...
with open("present_train_data.json", "w", encoding='utf-8') as f:
    ...
    for text, label in zip(X_train, y_train):
        f.write(json.dumps({"fact": text, "relevant_articles": label},ensure_ascii=False) + "\n")
